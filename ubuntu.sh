...
echo "vncserver -geometry 1600x900 -xstartup /usr/bin/startxfce4" >> /usr/local/bin/vncstart
...
echo
EOF
proot-distro login ubuntu                                                                            rm -rf $CHROOT/root/.bashrc
}
...
installing_ubuntutheme(){
echo ${G}"Installing Theme"${W}
mv $CHROOT/home/ubuntu/.bashrc $CHROOT/home/ubuntu/.bashrc.bak
echo "wget https://raw.githubusercontent.com/TecnicalBot/modded-distro/main/theme/theme.sh ; bash  t>
ubuntu                                                                                               rm $CHROOT/home/ubuntu/theme.sh*
...
sound_fix(){
echo ${G}"Fixing Sound..."${W}                                                                       pkg update
...
rm $CHROOT/home/ubuntu/.bashrc
mv $CHROOT/home/ubuntu/.bashrc.bak $CHROOT/home/ubuntu/.bashrc
wget -O $(find $CHROOT/home/ubuntu/.mozilla/firefox -name *.default-esr)/user.js https://raw.githubu>
}
